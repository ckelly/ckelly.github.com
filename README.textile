...
"My weblog":http://ckelly.net, now hosted on GitHub. Uses "Jekyll":http://github.com/mojombo/jekyll/tree/master for static site generation.
...
Portions of this code based on "Alex Payne's blog":http://github.com/al3x/al3x.github.com and the "Jekyll 960 project":http://github.com/btbytes/jekyll_960

All code is licensed under the "Apache License, Version 2.0":http://www.apache.org/licenses/LICENSE-2.0.html, reproduced below:

<blockquote>
Copyright 2010 Chris Kelly
